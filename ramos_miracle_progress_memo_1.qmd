...
#### Assessment Metric
Model performance will be evaluated using **Root Mean Squared Error (RMSE)** because it emphasizes large errors and aligns with our goal of accurate price prediction.
...
#### Potential Challenges
  - **Handling Outliers**: Extreme Airbnb prices, $10,000 listings, may affect performance. I may need to consider strong modeling techniques.
...
#### Final Project Goals
  ...
  - Interpret Findings & Complete Executive Summary
