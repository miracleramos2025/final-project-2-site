...
# Advanced recipe for feature engineering
# 2_recipe1_advanced.R
...
# define advanced recipe
recipe1_advanced <- recipe(price ~ ., data = airbnb_train) |>
...
# prep recipe
recipe1_advanced <- prep(recipe1_advanced)

# save / write out advanced recipe
save(recipe1_advanced, file = here("data/recipe1_advanced.rda"))
