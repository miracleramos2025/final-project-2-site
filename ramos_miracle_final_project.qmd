...
##### Interpretation of Metrics
  ...
  - **R-squared (0.134)**: The model explains only 13.4% of the variance in Airbnb prices. This suggests that other important factors like seasonality, amenities, and host behavior might be missing from our features.
...
##### Target Variable & Transformations
  ...
  - The final Linear Model was trained on the untransformed price, meaning all predictions and evaluations are in actual dollar values.
...
##### Key Takeaways
  ...
  - 25% of predictions are within $30.21 of the actual price.
  - The median error is $69.38, meaning half of the listings are predicted within $69.38 of their true price.
  - The 75th percentile error is $142.87. This shows that some listings have large errors, especially at higher price points.
...
If the goal is interpretability, this model is useful as it clearly shows how factors like location and room type impact price. 
...
Generative AI tools were occasionally used in this project to assist with minor code debugging and structuring explanations. This included troubleshooting small coding issues, refining visualization parameters, and enhancing clarity in markdown documentation.

All final model decisions, results, and interpretations were independently validated to ensure accuracy and alignment with project objectives.
